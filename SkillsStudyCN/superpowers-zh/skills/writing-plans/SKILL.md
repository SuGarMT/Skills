---
name: writing-plans
description: 当你有规范或需求用于多步骤任务时使用，在接触代码之前
---
...
编写全面的实现计划，假设工程师对我们的代码库零了解且品味存疑。记录他们需要知道的一切：每个任务要接触哪些文件、代码、测试、可能需要检查的文档、如何测试。以小任务的形式给他们完整的计划。DRY。YAGNI。TDD。频繁提交。
...
**1. 子代理驱动（此会话）** - 我为每个任务分派新的子代理，在任务之间审查，快速迭代

**2. 并行会话（单独）** - 打开新会话使用 executing-plans，带检查点的批量执行
